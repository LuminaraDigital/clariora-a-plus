    ...
    renderCertificateModal(cert) {
      ...
      modal.innerHTML = `
        <div style="background: #ffffff; color: #0f172a; border: 4px solid var(--gold-primary); border-radius: 12px; width: 100%; max-width: 680px; box-shadow: 0 15px 40px rgba(0,0,0,0.9); padding: 2.5rem; text-align: center; font-family: Georgia, 'Times New Roman', serif; position: relative;">
          ...
          <div style="font-size: 0.85rem; font-weight: 700; color: #16a34a; font-family: -apple-system, BlinkMacSystemFont, sans-serif; display: flex; align-items: center; gap: 6px;">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> 100% Pass Guarantee Active: If you fail on your first official attempt, you qualify for a full refund.
          </div>
        </div>
      `;
    }
