-- =====================================================================
-- Migration 0001: Initial Complete Clariora Edge D1 Schema
-- Includes users, auth, sync, item analytics, telegram/stars/ton billing,
-- AI usage logging, provider circuit states, coach jobs, and learner memories.
-- =====================================================================

-- 1. Users & Legacy Licensing
...
CREATE TABLE IF NOT EXISTS item_stats_cache (
    ...
    p_value REAL NOT NULL DEFAULT 0.70,
    point_biserial REAL DEFAULT 0.35,
    distractor_spread TEXT,
...
CREATE TABLE IF NOT EXISTS telegram_users (
    ...
    pro_preview_tokens_remaining INTEGER NOT NULL DEFAULT 3,
...
-- 8b. TON Pre-payment Orders (Tying on-chain payments to authenticated accounts)
...
-- 10. Auth accounts (Firebase Google/email + Telegram)
