"""
tools/build_az900_suite.py
Ingests Azure Mentor Study Guide and Microsoft Learning AZ-900 Labs,
extracts objectives, study library, and compiles high-yield blueprint-aligned
AZ-900 question bank shards with distractor analysis and scaled scoring metadata.
"""
...
ROOT = Path(".")
AZ_SOURCES = ROOT / "vendor_sources" / "az900"
GUIDE_DIR = AZ_SOURCES / "azure_mentor_guide"
LABS_DIR = AZ_SOURCES / "ms_learn_az900" / "Instructions" / "Labs"
SHARDS_DIR = ROOT / "shards" / "az900"
...
def extract_objectives_from_guide() -> list[dict]:
    objectives = []
    domains_map = [
        ("1-Describe cloud concepts", "1.0 Describe cloud concepts", "1.0"),
        ("2-Describe Azure architecture and services", "2.0 Describe Azure architecture and services", "2.0"),
        ("3-Describe Azure management and governance", "3.0 Describe Azure management and governance", "3.0")
    ]
        ...
        for line in content.splitlines():
            ...
            if line.startswith("## "):
                ...
                if match:
                    ...
                    objectives.append({
                        "id": f"az-{dom_code[0]}-{sub_idx}-{obj_counter}",
                        "exam": "az900",
                        "exam_code": "AZ-900",
                        "domain": domain_name,
...
# ---------------------------------------------------------------------------
# 2. Extract Hands-On Labs from Microsoft Learning
# ---------------------------------------------------------------------------
...
def extract_labs() -> list[dict]:
    ...
    for lab_file in sorted(LABS_DIR.glob("*.md")):
        content = lab_file.read_text(encoding="utf-8", errors="replace")
        lines = content.splitlines()
        title = lab_file.stem.replace("-", " ").title()
        for l in lines[:5]:
            if l.startswith("# "):
        ...
        labs.append({
            "id": f"lab-{lab_file.stem}",
            "filename": lab_file.name,
            "title": title,
            "category": "Azure Hands-On Lab",
            "exam": "az900",
...
# ---------------------------------------------------------------------------
# 3. Comprehensive Question Bank Shards (15 D1, 18 D2, 15 D3)
# ---------------------------------------------------------------------------
...
DOMAIN_1_QUESTIONS = [
    {
        ...
        "tags": ["cloud-concepts", "shared-responsibility", "iaas"]
    },
    {
        "id": "AZ-002",
        "exam": "az900",
        ...
        "tags": ["cloud-models", "hybrid-cloud", "bursting"]
    },
    {
        "id": "AZ-003",
        "exam": "az900",
        ...
        "tags": ["cloud-benefits", "elasticity", "autoscaling"]
    },
    {
        "id": "AZ-004",
        "exam": "az900",
        ...
        "tags": ["capex-opex", "consumption-model", "cloud-economics"]
    },
    {
        "id": "AZ-005",
        "exam": "az900",
        ...
        "tags": ["paas", "iaas", "saas", "cloud-service-types"]
    },
    {
        "id": "AZ-006",
        "exam": "az900",
        ...
        "tags": ["serverless", "azure-functions", "event-driven"]
    },
    {
        "id": "AZ-007",
        "exam": "az900",
        ...
        "tags": ["high-availability", "disaster-recovery", "resilience"]
    },
    {
        "id": "AZ-008",
        "exam": "az900",
        ...
        "tags": ["saas", "microsoft-365", "service-models"]
    },
    {
        "id": "AZ-009",
        "exam": "az900",
        ...
        "tags": ["agility", "cloud-benefits", "devops"]
    },
    {
        "id": "AZ-010",
        "exam": "az900",
        ...
        "tags": ["private-cloud", "cloud-models"]
    },
    {
        "id": "AZ-011",
        "exam": "az900",
        ...
        "tags": ["consumption-model", "pay-as-you-go", "cloud-economics"]
    },
    {
        "id": "AZ-012",
        "exam": "az900",
        ...
        "tags": ["fault-tolerance", "reliability", "cloud-concepts"]
    },
    {
        "id": "AZ-013",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["multi-cloud", "cloud-strategy"]
    },
    {
        "id": "AZ-015",
        "exam": "az900",
        ...
        "tags": ["scaling", "scale-up", "scale-out"]
    }
]
...
DOMAIN_2_QUESTIONS = [
    {
        ...
        "tags": ["availability-zones", "high-availability", "datacenter-resilience"]
    },
    {
        "id": "AZ-102",
        "exam": "az900",
        ...
        "tags": ["storage-redundancy", "lrs", "zrs", "grs"]
    },
    {
        "id": "AZ-103",
        "exam": "az900",
        ...
        "tags": ["blob-storage", "archive-tier", "cost-optimization"]
    },
    {
        "id": "AZ-104",
        "exam": "az900",
        ...
        "tags": ["networking", "expressroute", "hybrid-connectivity"]
    },
    {
        "id": "AZ-105",
        "exam": "az900",
        ...
        "tags": ["management-groups", "resource-hierarchy", "azure-governance"]
    },
    {
        "id": "AZ-106",
        "exam": "az900",
        ...
        "tags": ["regions", "azure-infrastructure"]
    },
    {
        "id": "AZ-107",
        "exam": "az900",
        ...
        "tags": ["region-pairs", "disaster-recovery"]
    },
    {
        "id": "AZ-108",
        "exam": "az900",
        ...
        "tags": ["sovereign-cloud", "azure-government"]
    },
    {
        "id": "AZ-109",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["azure-virtual-desktop", "vdi", "compute"]
    },
    {
        "id": "AZ-111",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["kubernetes", "aks", "containers"]
    },
    {
        "id": "AZ-113",
        "exam": "az900",
        ...
        "tags": ["cosmos-db", "nosql", "databases"]
    },
    {
        "id": "AZ-114",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["vnet-peering", "networking", "virtual-networks"]
    },
    {
        "id": "AZ-116",
        "exam": "az900",
        ...
        "tags": ["arm", "resource-manager", "infrastructure"]
    },
    {
        "id": "AZ-117",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["nsg", "security-rules", "networking"]
    }
]
...
DOMAIN_3_QUESTIONS = [
    {
        ...
        "tags": ["resource-locks", "governance", "accidental-deletion"]
    },
    {
        "id": "AZ-202",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["azure-advisor", "well-architected", "optimization"]
    },
    {
        "id": "AZ-204",
        "exam": "az900",
        ...
        "tags": ["rbac", "identity-access", "azure-roles"]
    },
    {
        "id": "AZ-205",
        "exam": "az900",
        ...
        "tags": ["entra-id", "identity", "authentication"]
    },
    {
        "id": "AZ-206",
        "exam": "az900",
        ...
        "tags": ["zero-trust", "cybersecurity", "principles"]
    },
    {
        "id": "AZ-207",
        "exam": "az900",
    ...
    },
    {
        ...
        "tags": ["defender-for-cloud", "cspm", "secure-score"]
    },
    {
        "id": "AZ-209",
        "exam": "az900",
        ...
        "tags": ["sentinel", "siem", "soar", "security-analytics"]
    },
    {
        "id": "AZ-210",
        "exam": "az900",
        ...
        "tags": ["key-vault", "secrets-management", "credentials"]
    },
    {
        "id": "AZ-211",
        "exam": "az900",
        ...
        "tags": ["pricing-calculator", "tco-calculator", "cost-management"]
    },
    {
        "id": "AZ-212",
        "exam": "az900",
        ...
        "tags": ["cost-management", "budgets", "billing"]
    },
    {
        "id": "AZ-213",
        "exam": "az900",
        ...
        "tags": ["resource-tags", "metadata", "governance"]
    },
    {
        "id": "AZ-214",
        "exam": "az900",
        ...
        "tags": ["application-insights", "azure-monitor", "telemetry"]
    },
    {
        "id": "AZ-215",
        "exam": "az900",
        ...
        "tags": ["service-health", "outages", "maintenance"]
    }
]
...
def main():
    print("Extracting Azure Mentor objectives...")
    objectives = extract_objectives_from_guide()
    print(f"Extracted {len(objectives)} objectives from Azure Mentor Guide.")
    
    obj_data = {
        "version": "1.0",
        "title": "Microsoft AZ-900 Official Objectives Checklist",
        "description": "Microsoft Azure Fundamentals (AZ-900) official domain and objective checklist.",
        "storage_key": "az900_objectives_progress_v1",
        "exams": {
            "az900": {
                "code": "AZ-900",
    ...
    (ROOT / "az900_objectives_data.json").write_text(json.dumps(obj_data, indent=2), encoding="utf-8")
    (ROOT / "az900_objectives_data.js").write_text(f"window.AZ900_OBJECTIVES_DATA = {json.dumps(obj_data, indent=2)};\n", encoding="utf-8")
    print("Wrote az900_objectives_data.json and az900_objectives_data.js")

    # Save question shards
    s1_path = SHARDS_DIR / "az900_1_0_cloud_concepts.json"
    # High-Yield Matching & Ordering items extracted from in28Minutes slide scenarios and Microsoft Press guides
    MATCH_QUESTIONS = [
        {
            "id": "AZ-M-01",
            "exam": "az900",
            ...
            "tags": ["compute", "scenarios", "match"],
            "pairs": [
                {"left": "Run serverless code solely in response to events with zero idle billing", "right": "Azure Functions"},
                {"left": "Deploy a managed Python web application with built-in auto scaling", "right": "Azure App Service"},
                {"left": "Quickly deploy a single container in seconds without VM management", "right": "Azure Container Instances (ACI)"},
                {"left": "Orchestrate a complex multi-container microservices architecture", "right": "Azure Kubernetes Service (AKS)"},
                {"left": "Workload requires customized OS kernel and legacy software installation", "right": "Azure Virtual Machines"}
            ]
        },
        {
            "id": "AZ-M-02",
            ...
            "tags": ["storage", "scenarios", "match"],
            "pairs": [
                {"left": "Persistent block storage attached to virtual machine operating system disks", "right": "Azure Disks"},
                {"left": "Synchronize on-premises enterprise file shares with Azure SMB shares", "right": "Azure File Sync"},
                {"left": "Petabyte-scale hierarchical data storage optimized for big data analytics", "right": "Azure Data Lake Storage Gen2"},
                {"left": "Very rarely accessed data stored for years with lowest per-GB storage cost", "right": "Archive Blob Storage"},
                {"left": "High-performance storage requiring highest IOPS and lowest latency SSDs", "right": "Premium Storage Account"}
            ]
        },
        {
            "id": "AZ-M-03",
            ...
            "tags": ["databases", "scenarios", "match"],
            "pairs": [
                {"left": "Fast-moving startup needing schemaless JSON document model with global replication", "right": "Azure Cosmos DB"},
                {"left": "Traditional enterprise banking application processing thousands of relational OLTP transactions", "right": "Azure SQL Database"},
                {"left": "Web application requires sub-millisecond response caching in front of database", "right": "Azure Cache for Redis"},
                {"left": "Business intelligence system running complex SQL analytics across petabytes of historical data", "right": "Azure Synapse Analytics"}
            ]
        },
        {
            "id": "AZ-M-04",
            ...
            "tags": ["networking", "security", "match"],
            "pairs": [
                {"left": "Create an isolated private network for cloud resources", "right": "Azure Virtual Network (VNet)"},
                {"left": "Connect resources in different VNets across regions over Microsoft backbone", "right": "Virtual Network Peering"},
                {"left": "Stateful managed network firewall controlling ingress/egress across subscriptions", "right": "Azure Firewall"},
                {"left": "Internal subnet packet filtering based on 5-tuple IP/port rules", "right": "Network Security Group (NSG)"},
                {"left": "Access Azure PaaS services privately over dedicated IP within your VNet", "right": "Azure Private Link & Endpoint"}
            ]
        },
        {
            "id": "AZ-M-05",
            ...
            "tags": ["governance", "management", "match"],
            "pairs": [
                {"left": "View upcoming planned datacenter maintenance and ongoing regional outages", "right": "Azure Service Health"},
                {"left": "Personalized best-practice recommendations on cost, security, and reliability", "right": "Azure Advisor"},
                {"left": "Collect operational telemetry, application performance logs, and smart metric alerts", "right": "Azure Monitor"},
                {"left": "Automatically enforce organizational compliance (e.g. restrict VM locations)", "right": "Azure Policy"},
                {"left": "Prevent accidental modification or deletion of critical production resources", "right": "Azure Resource Locks"}
            ]
        }
    ]
    ...
    ORDER_QUESTIONS = [
        {
            ...
            "tags": ["hierarchy", "governance", "order"],
            "sequence": [
        ...
        },
        {
            ...
            "tags": ["storage", "archive-tier", "order"],
            "sequence": [
    ...
    # Combine into shards
    DOMAIN_2_QUESTIONS.extend([q for q in MATCH_QUESTIONS if q["domain"].startswith("2.0")])
    DOMAIN_2_QUESTIONS.extend([q for q in ORDER_QUESTIONS if q["domain"].startswith("2.0")])
    DOMAIN_3_QUESTIONS.extend([q for q in MATCH_QUESTIONS if q["domain"].startswith("3.0")])

    s1_path = SHARDS_DIR / "az900_1_0_cloud_concepts.json"
    s2_path = SHARDS_DIR / "az900_2_0_azure_architecture_and_services.json"
    s3_path = SHARDS_DIR / "az900_3_0_azure_management_and_governance.json"
    ...
    print("Wrote updated AZ-900 domain shards to shards/az900/")

    # Master question bank compilation
    all_az_questions = DOMAIN_1_QUESTIONS + DOMAIN_2_QUESTIONS + DOMAIN_3_QUESTIONS
    master_bank = {
        "version": "1.1.0",
        ...
        "az900": all_az_questions
    }

    (ROOT / "az900_exam_data.json").write_text(json.dumps(master_bank, indent=2), encoding="utf-8")
    (ROOT / "az900_exam_data.js").write_text(f"window.AZ900_EXAM_DATA = {json.dumps(master_bank, indent=2)};\n", encoding="utf-8")
    print(f"Wrote {len(all_az_questions)} questions to az900_exam_data.json and az900_exam_data.js")

    # Build Study Library with Hands-On Labs and In28Minutes Scenario Tables
    print("Extracting MS Learn Hands-On Labs & Reference Scenarios...")
    labs = extract_labs()
    print(f"Extracted {len(labs)} hands-on labs from MicrosoftLearning.")

    scenario_cheat_sheets = [
        {
            "category": "Compute Decision Matrix",
            "summary": "Which Azure compute service to choose based on workload needs",
            "scenarios": [
                {"need": "Run function in response to events", "solution": "Azure Functions (Serverless)"},
                {"need": "Deploy web app or REST API with auto scaling", "solution": "Azure App Service (PaaS)"},
                {"need": "Quickly deploy single container without VM overhead", "solution": "Azure Container Instances (CaaS)"},
                {"need": "Complex multi-container microservice orchestration", "solution": "Azure Kubernetes Service (AKS)"},
                {"need": "Full OS control, custom software, lift-and-shift", "solution": "Azure Virtual Machines (IaaS)"},
                {"need": "Cloud-hosted multi-session virtual desktops", "solution": "Azure Virtual Desktop (AVD)"}
            ]
        },
        {
            "category": "Storage Decision Matrix",
            "summary": "Which Azure storage option to choose based on data type and access",
            "scenarios": [
                {"need": "Persistent virtual hard disks for Azure VMs", "solution": "Azure Disks (Block Storage)"},
                {"need": "Enterprise shared file shares accessible via SMB/NFS", "solution": "Azure Files"},
                {"need": "Sync on-premises Windows file servers with cloud", "solution": "Azure File Sync"},
                {"need": "Unstructured binary/text files accessed over HTTP/REST", "solution": "Azure Blob Storage"},
                {"need": "Rarely accessed archive data stored for 180+ days at minimum cost", "solution": "Archive Access Tier"},
                {"need": "Asynchronous microservice decoupling messages", "solution": "Azure Queue Storage"},
                {"need": "Petabyte-scale big data analytics with hierarchical namespace", "solution": "Azure Data Lake Storage Gen2"}
            ]
        },
        {
            "category": "Database Decision Matrix",
            "summary": "Which Azure database to choose based on relational vs NoSQL requirements",
            "scenarios": [
                {"need": "Schemaless global distribution with single-digit ms SLA", "solution": "Azure Cosmos DB (NoSQL)"},
                {"need": "Managed Microsoft SQL Server for OLTP relational transactions", "solution": "Azure SQL Database"},
                {"need": "In-memory caching for microsecond web application response", "solution": "Azure Cache for Redis"},
                {"need": "Petabyte-scale columnar data warehousing and analytics", "solution": "Azure Synapse Analytics (OLAP)"}
            ]
        },
        {
            "category": "Networking & Security Matrix",
            "summary": "Which networking or security control to choose based on perimeter needs",
            "scenarios": [
                {"need": "Isolated private cloud network perimeter", "solution": "Azure Virtual Network (VNet)"},
                {"need": "Private traffic routing between two VNets without internet", "solution": "VNet Peering"},
                {"need": "Centralized stateful firewall across subscriptions", "solution": "Azure Firewall"},
                {"need": "Subnet and VM NIC 5-tuple security filtering", "solution": "Network Security Group (NSG)"},
                {"need": "Access PaaS services privately over dedicated IP in VNet", "solution": "Azure Private Link & Endpoint"},
                {"need": "Secure browser-based RDP/SSH to VMs without public IP", "solution": "Azure Bastion Host"},
                {"need": "Dedicated private physical connectivity bypassing internet", "solution": "Azure ExpressRoute"},
                {"need": "Centralized secrets, keys, and TLS certificate storage", "solution": "Azure Key Vault"}
            ]
        },
        {
            "category": "Governance & Management Matrix",
            "summary": "Which governance or operations tool to choose based on management task",
            "scenarios": [
                {"need": "View active regional cloud outages and planned maintenance", "solution": "Azure Service Health"},
                {"need": "Automated recommendations across Cost, Reliability, Security", "solution": "Azure Advisor (5 Pillars)"},
                {"need": "Application performance monitoring, request rates, exception traces", "solution": "Application Insights (Azure Monitor)"},
                {"need": "Enforce organizational compliance rules at scale (e.g. allowed VM sizes)", "solution": "Azure Policy"},
                {"need": "Prevent accidental deletion of production resource groups", "solution": "Azure Resource Locks (CanNotDelete)"},
                {"need": "Manage access, policy, and compliance across multiple subscriptions", "solution": "Management Groups"}
            ]
        }
    ]

    # Extract Azure In Bullet Points notes
    bullet_dir = AZ_SOURCES / "azure_in_bullet_points" / "AZ-900 Microsoft Azure Fundamentals"
    bullet_notes = []
    if bullet_dir.exists():
        for f in sorted(bullet_dir.glob("*.md")):
            text = f.read_text(encoding="utf-8", errors="replace")
            domain = "1.0 Describe cloud concepts"
            if f.stem.startswith("2.3") or f.stem.startswith("2.6") or f.stem.startswith("3."):
                domain = "2.0 Describe Azure architecture and services"
            elif f.stem.startswith("2.") or f.stem.startswith("4.") or f.stem.startswith("5.") or f.stem.startswith("6.3") or f.stem.startswith("6.4"):
                domain = "3.0 Describe Azure management and governance"
            bullet_notes.append({
                "id": f"bp-{f.stem.replace(' ', '_').lower()}",
                "title": f.stem,
                "domain": domain,
                "content": text
            })
    print(f"Extracted {len(bullet_notes)} bullet-point reference modules from undergroundwires.")

    # Extract Ricardo Martins Cheat Sheet
    ricm_path = AZ_SOURCES / "ricmmartins_guide" / "README.md"
    ricm_content = ""
    if ricm_path.exists():
        ricm_content = ricm_path.read_text(encoding="utf-8", errors="replace")
        print("Extracted cheat sheet from ricmmartins study guide.")

    study_lib = {
        "version": "1.2.0",
        "track": "az900",
        "title": "Microsoft Azure Fundamentals Study Library & Lab Walkthroughs",
        "modules": [
            {
                "id": "mod-az-01",
                "title": "Domain 1: Cloud Concepts",
                "objectives": [o for o in objectives if o.get("domain", "").startswith("1.0")],
                "summary": "Covers high availability, scalability, elasticity, agility, fault tolerance, CapEx vs OpEx, and IaaS/PaaS/SaaS responsibility.",
                "bullet_points": [b for b in bullet_notes if b["domain"].startswith("1.0")]
            },
            {
                "id": "mod-az-02",
                "title": "Domain 2: Azure Architecture and Core Services",
                "objectives": [o for o in objectives if o.get("domain", "").startswith("2.0")],
                "summary": "Covers Regions, Availability Zones, Resource Groups, Subscriptions, Management Groups, Storage Tiers, and Networking.",
                "bullet_points": [b for b in bullet_notes if b["domain"].startswith("2.0")]
            },
            {
                "id": "mod-az-03",
                "title": "Domain 3: Azure Management and Governance",
                "objectives": [o for o in objectives if o.get("domain", "").startswith("3.0")],
                "summary": "Covers Microsoft Entra ID, RBAC roles, Resource Locks, Azure Policy, Microsoft Defender, and Azure Cost Management.",
                "bullet_points": [b for b in bullet_notes if b["domain"].startswith("3.0")]
            }
        ],
        "scenario_matrices": scenario_cheat_sheets,
        "ricm_cheat_sheet": ricm_content,
        "labs": labs
    }

    (ROOT / "az900_study_library.json").write_text(json.dumps(study_lib, indent=2), encoding="utf-8")
    (ROOT / "az900_study_library.js").write_text(f"window.AZ900_STUDY_LIBRARY = {json.dumps(study_lib, indent=2)};\n", encoding="utf-8")
    print("Wrote az900_study_library.json and az900_study_library.js")
    print("AZ-900 suite compilation complete!")
